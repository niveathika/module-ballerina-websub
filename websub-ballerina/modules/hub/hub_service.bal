...
public type HubService service object {
     ...
     //               returns TopicUnregistrationSuccess|error;

     // remote function onUpdateMessage(UpdateMessage msg)
     //              returns Acknowledgement|error;

     // remote function onSubscriptionIntentVerified(SubscriptionMessage msg);

     // remote function onUnsubscriptionIntenVerified(UnsubscriptionMessage msg);
